...
<html lang="en">
  <head>
    ...
    <link rel='mask-icon' href="https://raw.githubusercontent.com/ElemeFE/jade/dev/examples/assets/images/element-logo-small.svg" color="#409EFF">
  ...
  <body>
    ...
    <% if (process.env.NODE_ENV === 'production') { %>
      ...
      <script src="//shadow.elemecdn.com/app/jade/highlight.pack.b1f71b31-3c07-11e9-ba1a-55bba1877129.js"></script>
    <% } %>
  </body>
